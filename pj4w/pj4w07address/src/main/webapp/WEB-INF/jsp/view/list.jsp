<%--@elvariable id="contacts" type="java.util.Set<learn.ee.pj4w07address.Contact>"--%>
<%--@elvariable id="contact" type="learn.ee.pj4w07address.Contact"--%>
<!DOCTYPE html>
<html>
<head>
    ...
    <c:otherwise>
        <c:forEach items="${contacts}" var="contact">
            ...
            <c:if test="${contact.birthday != null}">
                ...
                'FULL', pageContext.response.locale)}&nbsp;${contact.birthday.dayOfMonth}<br />
            </c:if>
